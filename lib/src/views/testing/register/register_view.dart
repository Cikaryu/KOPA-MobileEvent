...
class RegisterView extends StatelessWidget {
            ...
            child: ListBody(
              children: <Widget>[
                GestureDetector(
                  child: Text('Camera'),
                  onTap: () {
                    _pickImage(ImageSource.camera, type, registerController);
                    Navigator.of(context).pop();
                  },
                ),
                SizedBox(height: 10),
                GestureDetector(
                  child: Text('Gallery'),
                  onTap: () {
                    _pickImage(ImageSource.gallery, type, registerController);
                    Navigator.of(context).pop();
                  },
                ),
              ],
  ...
  void _pickImage(ImageSource source, String type,
    ...
    if (pickedFile != null) {
      if (type == 'selfie') {
        registerController.setSelfieImage(File(pickedFile.path));
      } else {
        registerController.setKtpImage(File(pickedFile.path));
      }
    }
  }
}
