...
import 'package:app_kopabali/src/views/committee/pages/home_page/pages/Agenda/participant_agenda_view.dart';
import 'package:app_kopabali/src/views/committee/pages/home_page/pages/Participant_Benefit/participant_Benefit_view.dart';
import 'package:app_kopabali/src/views/committee/pages/home_page/pages/Venue/venue.dart';
import 'package:app_kopabali/src/views/committee/pages/home_page/pages/participant_kit/participant_kit.dart';
...
class _HomePageParticipantState extends State<HomePageCommittee> {
  ...
  Widget build(BuildContext context) {
    final HomePageCommitteeController homePageController =
        Get.put(HomePageCommitteeController());
